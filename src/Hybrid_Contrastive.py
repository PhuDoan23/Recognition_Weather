...
if __name__ == '__main__':
    ...
    # For plot_history we need a simplified test generator because plot_history calls `np.argmax(model.predict(...))`
    # Our model returns a dict `{'predictions': ..., 'features': ...}`. plot_history in utils doesn't handle dict returns natively.
    # Therefore, we will run the evaluation manually or just print results.
